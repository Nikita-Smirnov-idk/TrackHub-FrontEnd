                    ...
                    VStack(spacing: 0) {
                        ...
                        ZStack {
                            ...
                            VStack(alignment: .center, spacing: geometry.size.height * 0.018) {
                                ...
                                SignUpButton(geometry: geometry, mainManager: viewManager, isSignUp: $isCorrectData, showAlert: $showAlert, signInUserData: SignInUserModel(email: user.email, password: user.password), signUpUserData: user)
